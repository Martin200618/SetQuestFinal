...
function MoverObstaculos() {
  var factorVelocidadOpstaculos = 3.8; // Ajusta la velocidad de los obstáculos
...
function MoverEstrellas() {
  var factorVelocidadEstrellas = 4; // Ajusta este valor para cambiar la velocidad de las estrellas
...
var velocidadMovimiento = 400; // Velocidad en píxeles por segundo
...
function createRaindrop() {
  ...
  const speed = Math.random() * 15 + 15; // Speed of the raindrop
